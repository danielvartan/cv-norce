...
metathis::meta() |>
  metathis::meta_name("github-repo" = "danielvartan/cv-norce") |>
  metathis::meta_social(
    title = "Daniel Vartanian's CV",
    url = "https://danielvartan.github.io/cv-norce",
    og_type = "website",
...
data_location <- paste0(
  ...
  "1gJqMtua6_Fs_qANpoZkYcgVhGMtWGcd4ejXQvPvDIn0"
)
...
if (isTRUE(params$pdf_mode)) {
  cat(
    ...
    "[danielvartan.github.io/cv-norce]",
    "(https://danielvartan.github.io/cv-norce)",
    "</p>",
    sep = ""
  )
} else {
...
Source code available at [github.com/danielvartan/cv-norce](https://github.com/danielvartan/cv-norce)
